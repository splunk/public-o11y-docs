To use this Smart Agent monitor with the Collector, include the Smart Agent receiver in your configuration file. The Smart Agent receiver is fully supported only on x86_64/amd64 platforms.
