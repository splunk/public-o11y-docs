...
A metric is anything that is measurable (you can assign a numerical value to it) and variable (changes over time). A log is an automatically generated, time-stamped record of each event relevant to a specific system.
