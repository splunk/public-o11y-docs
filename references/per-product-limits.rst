...
Each Observability Cloud product has a maximum number of MTS you can create per minute. For example, if you create 5,500 MTS in the first minute for Infrastructure Monitoring, you'll have to wait until the next minute to create more MTS. However, in the first minute you can also create another 6,000 more MTS for any other product you use.
