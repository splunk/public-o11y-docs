...
Splunk Observability Cloud has 2 types of tokens:

* Session tokens are valid for a short period. See :ref:`admin-api-access-tokens`.
* Org tokens are valid for an extended period. See :ref:`admin-org-tokens`.
