...
The product-specific integrations provide default values for most of these fields and you don't have to configure them manually. When setting up generic SAML or Microsoft Entra ID Federation Searches (FS), you need to provide all the values yourself. 

The following table uses Microsoft Entra ID as an example and shows the corresponding field names in Splunk Observability Cloud. Different IdPs may have slightly different field names. Example values are indicated in brackets.
...
.. list-table::
   ...
   * - :strong:`Splunk Observability Cloud field name`
     - :strong:`Microsoft Entra ID field name`
