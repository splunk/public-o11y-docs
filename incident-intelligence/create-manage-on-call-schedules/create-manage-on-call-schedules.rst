...
Now that you've created an on-call schedule, add it to the incident workflow for the relevant incident policy. Responders are not paged when until the schedule is included as a step in an incident workflow. To learn how to add schedules to the incident workflow, see :ref:`ii-configure-incident-workflows`.
