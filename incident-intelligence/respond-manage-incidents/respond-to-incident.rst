...
.. list-table::
   ...
   * - Dismissed
     - Dismissed incidents are considered invalid and closed. After you dismiss an incident you can't make updates to the incident. Setting an incident status to dismissed prevents further notifications. 
