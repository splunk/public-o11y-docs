...
.. list-table::
  ...
  * - Metric category
    - Description
  * - Host
    - Metrics generated by hosts.
  * - Container
    - Metrics generated by containers.  
  * - Custom
    - Metrics reported to Observability Cloud outside of the host, container, or bundled metrics. Bundled metrics might result in increased data ingest costs..
  * - Bundled
  ...
  * - APM Bundled
    - Additional metrics sent through APM.   

Metrics can fall in one or more categories, which impacts billing. Read more in :ref:`about-custom-high-res`.
