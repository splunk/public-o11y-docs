...
By converting a custom property to a dimension, you can display it in an alert message. To learn more, see :new-page:`Developer documentation for the promote method <https://dev.splunk.com/observability/docs/signalflow/methods/promote_stream_method/>`.
