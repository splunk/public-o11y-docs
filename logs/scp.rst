...
10. Go back to the Log Observer Connect guided setup and open the third section called :guilabel:`Secure connection to the Splunk platform`. Upload the certificate you downloaded in the previous step.
