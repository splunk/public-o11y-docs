...
# Collectd Kafka consumer
<meta name="Description" content="Use this Splunk Observability Cloud integration to monitor Collectd Java-based Kafka consumer. See benefits, install, configuration, and metrics">
