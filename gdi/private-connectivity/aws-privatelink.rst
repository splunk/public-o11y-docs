...
.. note:: Use AWS PrivateLink to send metrics and traces to Splunk Observability Cloud. To send logs, use :new-page:`Private connectivity in Splunk Cloud Platform <https://docs.splunk.com/Documentation/SplunkCloud/latest/Security/Privateconnectivityenable>`.
