...
To send custom metrics to Splunk Observability Cloud, see :ref:`send-custom-metrics`. To learn more about the data model of Splunk Observability Cloud, see :ref:`data-model`.
