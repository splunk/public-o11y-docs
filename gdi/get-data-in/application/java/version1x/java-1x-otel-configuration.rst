...
.. _advanced-java-otel-configuration-1x:
...
.. _configuration-methods-java-1x:
...
.. _trace-exporters-settings-java-1x:
...
.. _trace-sampling-settings-java-1x:
...
.. _trace-propagation-configuration-java-1x:
...
.. _profiling-configuration-java-1x:
...
.. _metrics-configuration-java-1x:
...
.. list-table::
   ...
   * - ``SPLUNK_METRICS_ENDPOINT``
     - The OTel collector metrics endpoint. Default is ``http://localhost:9943/v2/datapoint``. |br| |br| System property: ``splunk.metrics.endpoint``
...
.. _server-trace-information-java-1x:
