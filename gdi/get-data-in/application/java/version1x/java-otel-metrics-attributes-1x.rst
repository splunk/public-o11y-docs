.. caution::
   ...
   New customers should use the latest version of the :ref:`Splunk Distribution of OpenTelemetry Java <get-started-java>`. Existing customers should consider migrating to version 2.0 or higher. To learn how to migrate, see :ref:`java-metrics-migration-guide`.
...
The agent of the Splunk Distribution of OpenTelemetry Java 1.x collects the following application metrics data and attributes in addition to all that the upstream OpenTelemetry agent collects. To learn about the different metric types, see :ref:`metric-types`.

.. note:: To migrate from OpenTelemetry native metrics, see :ref:`java-metrics-migration-guide`.

.. _java-otel-metrics-1x:
...
.. _supported_libraries_java_metrics-1x:
...
.. list-table::
  ...
  * - :ref:`Apache DBCP2 connection pool metrics <connection-pool-metrics-1x>`
    - ``commons-dbcp2-splunk``
    - Version 2.0 and higher
  * - :ref:`c3p0 connection pool metrics <connection-pool-metrics-1x>`
    - ``c3p0-splunk``
    - Version 0.9.5 and higher
  * - :ref:`HikariCP connection pool metrics <connection-pool-metrics-1x>`
    - ``hikaricp-splunk``
    - Version 3.0 and higher
  * - :ref:`Oracle Universal Connection Pool metrics (UCP) <connection-pool-metrics-1x>`
    - ``oracle-ucp-splunk``
    - Version 11.2.0.4 and higher
  * - :ref:`Tomcat JDBC connection pool metrics <connection-pool-metrics-1x>`
    - ``tomcat-jdbc-splunk``
    - Version 8.5 and higher
  * - :ref:`Vibur DBCP connection pool metrics <connection-pool-metrics-1x>`
    - ``vibur-dbcp-splunk``
    - Version 20.0 and higher
  * - :ref:`Tomcat thread pool metrics <thread-pool-metrics-1x>`
    - ``tomcat``
    - Version 8.5 and higher
  * - :ref:`WebSphere Liberty thread pool metrics <thread-pool-metrics-1x>`
    - ``liberty``
    - Version 20.0.0.12
  * - :ref:`WebLogic thread pool metrics <thread-pool-metrics-1x>`
    - ``weblogic``
...
.. _webengine-attributes-java-otel-1x:
