...
.. meta::
   :description: Minimum requirements of the Splunk OTel JS agent, as well as potential constraints impacting performance, and guidelines to optimize and troubleshoot the performance of the agent.
