...
#. (Optional) If you want to verify that the instrumentation is working by viewing the telemetry data output in your console, add ``console`` to value of the following environment variables:
