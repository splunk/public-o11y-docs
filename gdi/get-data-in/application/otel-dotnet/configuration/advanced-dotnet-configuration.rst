...
.. list-table:: 
   ...
   * - ``SIGNALFX_SERVICE_NAME``
     - The name of the application or service. If not set, the instrumentation looks for a suitable default name. See :ref:`dotnet-otel-default-service-name`.
   * - ``SIGNALFX_VERSION``
   ...
   * - ``SIGNALFX_TRACE_CONFIG_FILE``
     - Path of the JSON configuration file. Set this environment variable if you're configuring the instrumentation using a JSON file. See :ref:`configuration-methods-dotnet-otel` for more information.
...
.. _profiling-configuration-dotnet-otel:
...
.. _dotnet-otel-instrumentation-libraries-settings:
...
.. _dotnet-otel-instrumentation-query-strings:
