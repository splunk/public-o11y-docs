...
.. note:: The SignalFx C# Azure Function wrapper is deprecated. Use the method described here to instrument your Azure functions.
...
2. Add the required libraries using NuGet
=================================================
...
4. Instrument the code to send spans
=================================================

The last step is instrumenting your code using OpenTelemetry:
