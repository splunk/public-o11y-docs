...
.. note:: The MongoDB monitor is deprecated and will reach end of support on January 25, 2025. During this period, only critical security and bug fixes are provided. When the monitor reaches end of support, you won't be able to use it to send data to Splunk Observability Cloud.
