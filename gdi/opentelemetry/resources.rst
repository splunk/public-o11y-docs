...
.. list-table::
  ...
  *   - Agent or Data forwarding mode
      - In Host monitoring mode, the Collector runs with the application or on the same host as the application. In Data forwarding mode, one or more collectors run a standalone service, for example, a container or deployment. See :ref:`otel-deployment-mode`.
  *   - Ports and endpoints
