...
If you already installed Fulentd on a host, then install the Splunk OTel Collector without Fluentd using the command ``--without-fluentd``. For more information, see :ref:`otel-configuration`. 
