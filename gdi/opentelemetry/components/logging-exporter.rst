...
By default, the Splunk Distribution of OpenTelemetry Collector includes the logging exporter with verbosity set to ``detailed`` when deploying in Host monitoring mode. See :ref:`otel-deployment-mode` for more information.
