...
By default, the Splunk Distribution of OpenTelemetry Collector includes the Splunk HEC exporter in the ``logs`` pipeline when deploying in Host monitoring mode. See :ref:`otel-deployment-mode` for more information.
