...
By default, the Splunk Distribution of OpenTelemetry Collector includes the batch processor in all the predefined pipelines when deployed in agent or Data forwarding modes. See :ref:`otel-deployment-mode` for more information.
