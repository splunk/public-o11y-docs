...
By default, the Splunk Distribution of OpenTelemetry Collector includes the Prometheus receiver in the ``metrics/internal`` pipeline when deploying in Host monitoring. See :ref:`otel-deployment-mode` for more information.
