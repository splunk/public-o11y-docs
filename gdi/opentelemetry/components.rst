...
.. list-table::
   ...
   * - ``k8s_observer``
     - Uses the Kubernetes API to discover pods running on the local node. See :ref:`receiver-creator-receiver` for more information. See :ref:`receiver-creator-receiver` for more information.
   * - ``memory_ballast``
