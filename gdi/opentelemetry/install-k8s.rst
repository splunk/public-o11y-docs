...
Determine which :ref:`otel-deployment-mode` you want to use, agent or gateway. By default, Host monitoring mode is configured to send data directly to Splunk SaaS endpoints. Host monitoring mode can be reconfigured to send to a gateway.
