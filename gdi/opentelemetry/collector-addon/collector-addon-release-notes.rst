.. _collector-addon-release-notes:

*********************************************************************************************
Release Notes for the Splunk Add-On for the OpenTelemetry Collector
*********************************************************************************************

.. meta::
   :description: Release Notes for the Splunk Add-On for the OpenTelemetry Collector.
...
.. list-table::
   ...
   *  - 1.4.2
      - :new-page:`https://github.com/signalfx/splunk-otel-collector/releases/tag/v0.122.0`
      - Uses v0.122.0 of the Splunk distribution of the OpenTelemetry Collector
