...
There are a variety of default configuration files you can use for configuring the Splunk Distribution of OpenTelemetry Collector, as well additional components that you can configure separately.
