...
the Prometheus metric types to Splunk Observability Cloud metric types as described in the documentation for [prometheus-exporter](../monitors-prometheus/prometheus-exporter.md). All Prometheus labels are converted directly to Infrastructure Monitoring dimensions. 
