...
.. caution:: Smart Agent monitors are being deprecated. To collect DNS data with OpenTelemetry and the Telegraf DNS Query Input plugin see :ref:`telegraf-generic`.
