...
The {ref}`Splunk Distribution of OpenTelemetry Collector <otel-intro>` uses the {ref}`Smart Agent receiver <smartagent-receiver>` with the Network protocols monitor type to gather metrics about the network protocol stacks running on the system.
