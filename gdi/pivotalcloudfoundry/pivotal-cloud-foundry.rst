...
The script uses the variables described in the following table: 
   ...
   .. list-table:: Variables
      ...
      * - ``IS_DEV_RELEASE``
        ...
        - ``false (0)``
      * - ``UPLOAD_RELEASE``
        - Boolean (int). If this variable is set to ``true``, the script uploads the release to the BOSH Director, which is primarily used for GitHub's workflow for testing.
        - ``true (1)``
