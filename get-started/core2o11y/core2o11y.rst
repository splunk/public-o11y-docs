...
.. toctree::
   ...
   Extend the Splunk platform into observability with Splunk Observability Cloud <compare/compare>
...
Splunk Observability Cloud adds the power of automated observability to your Splunk platform instance. See :ref:`compare-compare` to learn more about how Observability Cloud enables the Splunk platform to correlate logs with metrics and traces in a modern, streaming analytics engine.
...
The principles of reliability fall into four main categories of practice. Select each of the following categories to learn how you can execute on each major observability practice and maintain reliability with Observability Cloud:
...
See :ref:`setup-o11y-setup-o11y` to learn how to set up each component of Observability Cloud.
