...
Before you start, we recommend you to create a plan for how you want to set up your Observability Cloud organization. For information about how to plan for and set up your Observability Cloud organization, see :ref:`admin-admin`.
...
As a part of getting data in, make sure to consider bringing in data in a way that enables :ref:`get-started-relatedcontent`, a feature that automatically correlates data between different views within Observability Cloud. When enabled, the Related Content bar displays automatically when a you select a relevant element and allows you to easily take a data-driven investigative approach. 
...
- Set up :ref:`detectors <create-detectors>` to send alerts when data conditions that are important to you are met.
