...
.. list-table::
   ...
   * - Splunk virtual compute (SVC) optimization
     - You can optimize SVC, positively impacting performance and cost, by using new :guilabel:`Play`, :guilabel:`Pause`, and :guilabel:`Run` search buttons in the UI. The default limit is 150,000 logs. For more information, see :ref:`logs-keyword`.
