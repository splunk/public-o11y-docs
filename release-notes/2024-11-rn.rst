...
.. list-table::
   ...
   * - Tag Spotlight enhancements in APM and RUM
     - You can now rearrange the cards on the Tag Spotlight page by priority order to view your most important tags. For more information, see :ref:`apm-tag-spotlight`.
