...
.. list-table:: 
  ...
  * - New feature or enhancement
    - With the recent GA of Related Content in Splunk Cloud, users now have a contextual experience for correlating  Splunk Observability Cloud workloads with their events in Splunk Search. Users, however, still have to manually determine insights from the views and hunt down true root cause. By integrating the O11y AI Assistant into Related Content, Splunk Search users can now get immediate insights across their entire Observability footprint for faster MTTI and MTTR. This RDMP item captures the progress of integrating the O11y AI Assistant into Related Content in Splunk Cloud. 
  * - Related content integration with AI assistant
    - Placeholder
  * - APM profiling on GCP realms
    - Placeholder
  * - APM service-centric navigation and filtering
    - Placeholder
  * - Downtime configuration for Synthetics
    - Placeholder
