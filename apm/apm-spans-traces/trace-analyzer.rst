...
#. Use the trace view selection to select to view trace and error counts or duration in the chart.
#. Use the minimum and maximum trace duration to refine the traces that are included by their duration.
#. Use the sample ratio to select to include all traces or 10% of traces. 
