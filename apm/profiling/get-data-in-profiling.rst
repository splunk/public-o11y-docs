...
.. tabs::
   ...
   .. group-tab:: Java
      ...
      - Make sure that the ``splunk.profiler.logs-endpoint`` system property or the ``SPLUNK_PROFILER_LOGS_ENDPOINT`` environment variable point to ``http://localhost:4317``  or to the Splunk Distribution of OpenTelemetry Collector.
