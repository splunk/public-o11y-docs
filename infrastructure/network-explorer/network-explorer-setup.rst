...
For the Splunk Distribution of OpenTelemetry Collector to work with Network Explorer, you must install it in Data forwarding mode, and perform the following steps:
