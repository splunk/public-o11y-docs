...
.. note::
  This quick start tutorial covers a multiple types of platform and cloud infrastructure. For a quick start tutorial that focuses specifically on monitoring Kubernetes clusters in Splunk Observability Cloud, see :ref:`Monitor your Kubernetes environment in Splunk Observability Cloud <about-k8s-tutorial>`. 
