...
For instructions on how to customize navigators by adding to or removing from the group of built-in dashboards associated with them, see :ref:`manage-navigator-dashbds`.
